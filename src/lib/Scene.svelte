...
useDraco: true
  ...
  // onClick
    ...
    const setHoverArea = (name,e) => {
		hovered = name;
        hoveredMeshColor = materials[name].color
        // convert rgb to hex 
        hoveredMeshColor = hoveredMeshColor.getHexString()
        console.log(hoveredMeshColor)
	};
  ...
  <T.Group position={[0, 0, 0]}>
    ...
    >   
        <InteractiveObject 
            ...
            interactive 
            on:click={onClick} 
            on:pointerenter={() => setHoverArea('laces')}
    ...
    <InteractiveObject 
        ...
        interactive 
        on:click={onClick}
        on:pointerenter={() => setHoverArea('mesh')}
			on:pointerleave={() => (hovered = null)}
    />
    </T.Mesh>
    ...
    <InteractiveObject 
            ...
            interactive 
            on:click={onClick}
            on:pointerenter={() => setHoverArea('caps')}
			on:pointerleave={() => (hovered = null)}
            />
    </T.Mesh>
    ...
    <InteractiveObject 
            ...
            interactive 
            on:click={onClick}
            on:pointerenter={() => setHoverArea('inner')}
			on:pointerleave={() => (hovered = null)}
            />
    </T.Mesh>
    ...
    <InteractiveObject 
            ...
            interactive 
            on:click={onClick}
            on:pointerenter={() => setHoverArea('sole')}
			on:pointerleave={() => (hovered = null)}
            />
    </T.Mesh>
    ...
    <InteractiveObject 
            ...
            interactive 
            on:click={onClick}
            on:pointerenter={() => setHoverArea('stripes')}
			on:pointerleave={() => (hovered = null)}
            />
    </T.Mesh>
    ...
    <InteractiveObject 
            ...
            interactive 
            on:click={onClick}
            on:pointerenter={() => setHoverArea('band')}
			on:pointerleave={() => (hovered = null)}
            />
    </T.Mesh>
    <!-- Patch -->
    ...
    <InteractiveObject 
            ...
            interactive 
            on:click={onClick}
            on:pointerenter={() => setHoverArea('patch')}
			on:pointerleave={() => (hovered = null)}
            />
    </T.Mesh>
